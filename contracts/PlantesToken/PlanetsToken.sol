...
contract KBKToken is ERC20, ITokenInterface, Ownable {
    ...
    uint internal constant MiningLimit = 97e8 * 10 ** 18;
    ...
    constructor(address _fundReceiver, address _developFund,
        address _usdt, address router) ERC20("KBKcoin Token", "KBKcoin"){
        ...
        isCommunityAddress[_fundReceiver] = true;
        isCommunityAddress[_developFund] = true;
